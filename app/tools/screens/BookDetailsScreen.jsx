...
import Icon from 'react-native-vector-icons/AntDesign'; // Changed this line
...
function BookDetailsScreen({ navigation, route }) {
    ...
    function normalize(size, scale = 375) {
      const newSize = (size * width) / scale;
      ...
      <>
        ...
        >
          <Animated.View style={anims.screen}>
            ...
            <Icon size={27} name="close" onPress={goBack} style={styles.closeIcon} />
            ...
            <Animated.View style={anims.scrollView}>
              ...
              <Button onPress={openSheet} style={styles.addButton}>
                <Icon size={21} name={getIcon(item?.status)} style={styles.addIcon} />
              </Button>
            </Animated.View>
          </Animated.View>
        </PanGestureHandler>
